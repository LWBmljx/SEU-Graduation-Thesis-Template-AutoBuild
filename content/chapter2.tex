...
\begin{seulongtable}[tab:long-demo]{@{\extracolsep{\fill}}ccccc}{长表格示例}{序号 & 产品 & 产量 & 销量 & 产值}
  1 & 手机 & 11000 & 10000 & 500 \\
  2 & 电视机 & 5500 & 5000 & 220 \\
  \newpage
  3 & 计算机 & 1100 & 1000 & 280 \\
  4 & 平板电脑 & 2600 & 2300 & 180 \\
  5 & 智能手表 & 3200 & 3000 & 120 \\
\end{seulongtable}
...
\begin{center}
  ...
  \begin{tabular*}{16.48cm}{@{\extracolsep{\fill}}lcccccccccccc}
    \toprule
    & \multicolumn{4}{c}{Stage 1 (>7.1 $\mu$m)} &
      \multicolumn{4}{c}{Stage 2 (4.8--7.1 $\mu$m)} &
      \multicolumn{4}{c}{Stage 3 (3.2--4.7 $\mu$m)} \\
